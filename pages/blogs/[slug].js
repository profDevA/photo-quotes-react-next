    ...
    <>
      <Head>
        ...
        <title>
          {article &&
            (article.meta_title !== ""
              ? article.meta_title + " - PhotoQuotes"
              : article.title + " - PhotoQuotes")}
        </title>
        <meta
          name="description"
          content={
            article && article.meta_description && article.meta_description
          }
        />
          ...
          <section className="container inner-container pb160">
            <div className="side-col-container side-col-container__inner row">
              ...
              <div className="side-col-container__right col-xl-3 col-lg-4">
                <div className="info">
                  <p className="text20 gray-font">
                    By <span className="dark-gray-font">Palm</span>
                  </p>
              ...
              <div className="row mt80">
                  ...
                  <div className="article slider-item-blog">
                    ...
                    <div className="article-content">
                      <p className="article-content__text text18">
                        ...
                        cultural, personal, and more. There are things we have
                ...
                <div className="col-4">
                  <div className="article slider-item-blog">
                    ...
                    <div className="article-content">
                      <p className="article-content__text text18">
                        During the internet’s nascent life, a lot of
                        researchers, early adopters, and enthusiasts recognized
                        that the technology would pose serious problems for
                        acting anonymously online. The very nature of internet
