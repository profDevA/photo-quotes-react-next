...
export default function OnePhotoQutote() {
    return (
        <>
            <Header />
            <main>
                <section className="container container-blog pt80 pb120">
                    <div className="card big-card image-card no-maxw wow zoomIn">
                ...
                <section className="pb80">
                    <div className="banner-container banner-container-728">
                        <img src="assets/google-728.jpg" alt="" className="banner" />
                    </div>
                </section>
            </main>
            <Footer />
