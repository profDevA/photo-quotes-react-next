...
export default function Tag() {
    return (
        <>
            <Header title={'PhotoQuotes - Tags'} />
            <main>
                <section className="container pt80">
                    <div className="nav-chain">
                        <ul>
                            ...
                            <li className="active"><a href="#">Photography quotes</a></li>
                        </ul>
                    </div>
                    <div className="row">
                        <div className="col line__title">
                            <h1 className="main-title">#photography</h1>
                            <h2 className="big-lettering">quotes</h2>
                        </div>
                    </div>
                </section>
                <section className="container container-latest mtb80">
                    <div className="row pb80 justify-content-md-between">
                        <div className="col-12 col-lg-6 wow zoomIn">
                            <div className="quote mt0">
                                ...
                                <div className="quote__center">
                                    <p>“None. They should just go out and photograph and stop talking about it. That’s the only way
                                    they are going to find themselves. They can’t do it in their heads – they have to go out and
                            do it in the camera and get it on film.”</p>
                                </div>
                                ...
                                <div className="quote__meta">
                                    <p className="gray-font">when asked is she had any gems of wisdom for the photographer today.,
                            Professional photographer's survival guide by Charles E. Rotkin</p>
                                </div>
                                <div className="quote__meta">
                            ...
                            <div className="card image-card middle-card mt80">
                                ...
                                <div className="card__content">
                                    ...
                                    <div className="card__text">
                                        <p>It is or should be a significant document, a penetIt is or should be a significant
                                        document, a penetrIt is or should be a significant document, a penetrIt is or should be
                                        a significant document, a penetrIt is or should be a significant document, a penetrIt is
                                        or should be a significant document, a penetrIt is or should be a significant document,
                                        a penetrIt is or should be a significant document, a penetrIt is or should be a
                                        significant document, a penetrrating statement, which can be described in a very simple
                                term.</p>
                                    </div>
                        ...
                        <div className="col-12 col-lg-6 wow zoomIn" data-wow-delay=".2s">
                            <div className="quote mt0">
                                ...
                                <div className="quote__center">
                                    <p>
                                        The art is the challenge which you must meet every day: the technique you should learn to
                                        control with time. The science and the art of photography are really one, and not opposed to
                                        each other.
                        </p>
                                </div>
                                <div className="quote__bottom">
