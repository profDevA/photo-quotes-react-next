                ...
                <section className="hero-section__white hero-section row container ptb90">
                    <div className="hero-section__left col-xl-4 col-lg-5 col-12 wow fadeInRight">
                        <div className="hero-section__left_top">
                            <h2 className="big-lettering tab-title" data-tab="tab-1">Quotes by</h2>
                            <h2 className="big-lettering tab-title" data-tab="tab-2">Books about</h2>
                            <h2 className="big-lettering tab-title" data-tab="tab-3">Interviews with</h2>
                            <h2 className="big-lettering tab-title" data-tab="tab-4">Articles about</h2>
                            <h2 className="big-lettering tab-title" data-tab="tab-5">Photographs by</h2>

                            <h1 className="mt10 main-title">Abbott Berenice</h1>
                    ...
                    <div className="hero-section__right col-xl-8 col-lg-7 col-12 wow fadeInRight" data-wow-delay=".2s">
